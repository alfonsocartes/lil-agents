...
/// for real would actually add/remove lil agents from the user's login items
...
final class LoginItemController {
    ...
    /// lil agents to start at login?" prompt. For someone upgrading from a
...
struct SMAppServiceLoginItemBackend: LoginItemBackend {
    ...
    /// `.build/debug/LilAgents`, which won't exist past the next clean build
